function TimelineItem({ data, index }) {
    return (
        <>
            <div className={`w-8/10 sm:w-4/10 bg-white rounded-xl p-2 translate-x-5 relative ${index % 2 ? "sm:-translate-x-[52%]" : "sm:translate-x-[52%]"}`}>
                ...
                <div className={`flex gap-2 ${index % 2 ? 'sm:flex-row-reverse' : 'sm:flex-row'}`}>
                    ...
                    <div className="flex-3/10 rounded-xl overflow-hidden">
                        <img src="https://picsum.photos/200/300" alt="" className="aspect-square object-cover" />
                    </div>
                </div>
            </div>
        </>
